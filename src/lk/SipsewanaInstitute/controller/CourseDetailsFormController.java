...
public class CourseDetailsFormController {
    ...
    public void initialize() {
        ...
        /* set course detail to the table column */
    ...
    /* load course detail to the table */
    ...
    /* click table row to see register course details to load */
